...
describe('QuestionAndAnswerForm', () => {
    ...
    test('submits the form and shows completion screen when all answers are provided', async () => {
        ...
        // Check if we see the completed screen
        expect(screen.getByText(/quiz completed successfully/i)).toBeInTheDocument();
        expect(onComplete).toHaveBeenCalledWith({ "1": "Alice", "2": "To find the Holy Grail" });
