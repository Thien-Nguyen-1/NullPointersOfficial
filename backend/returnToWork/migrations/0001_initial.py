# Generated by Django 5.1.5 on 2025-03-13 14:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_type",
                    models.CharField(
                        choices=[("admin", "Admin"), ("service user", "Service user")],
                        max_length=30,
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="%(class)s_author_contents",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="modules_for_tag", to="returnToWork.tags"
            ),
        ),
        migrations.AddField(
            model_name="user",
